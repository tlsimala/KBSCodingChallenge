...
public class Compound {
	...
	public void AddPlate(Plate plate) {
		...
		storage.put(plate, wellList); //puts the plate in the hashmap and creates an arraylist for the particular plate
	}
	...
	public void AddWell(Plate plate, Well well) {
		...
		cloneWellList.add(well); //adds well in the arraylist 
	}
